...
TEST_F(CustomImageHost, returns_expected_data_for_snapcraft_core)
{
    ...
    EXPECT_THAT(info->image_location,
                Eq(QUrl::fromLocalFile(test_path + "xenial-20200708.2.img").toString()));
...
TEST_F(CustomImageHost, returns_expected_data_for_snapcraft_core18)
{
    ...
    ASSERT_TRUE(info);
    EXPECT_THAT(info->image_location,
                Eq(QUrl::fromLocalFile(test_path + "bionic-20200708.img").toString()));
...
TEST_F(CustomImageHost, returns_expected_data_for_snapcraft_core20)
{
    ...
    ASSERT_TRUE(info);
    EXPECT_EQ(QUrl::fromLocalFile(test_path + "focal-20200708.img").toString(), info->image_location);
